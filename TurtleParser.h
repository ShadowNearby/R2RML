...
private:
    ...
    public:
        ...
        {
            putBack = t;
            if (t >= Token_Integer) putBackValue = s;
        }
        ...
        {
            putBack = t;
            if (t >= Token_Integer) putBackValue = ignored;
        }
    ...
    struct Triple
    {
        ...
        Triple(std::string subject, std::string predicate, std::string object,
               Type::Type_ID objectType, std::string objectSubType) : subject(std::move(subject)),
                                                                      predicate(std::move(predicate)),
                                                                      object(std::move(object)),
                                                                      objectSubType(std::move(objectSubType)),
...
public:
    ...
    bool parse(std::string &subject, std::string &predicate, std::string &object, Type::Type_ID &objectType,
