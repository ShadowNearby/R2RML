...
typedef struct sub_type{
    ...
    std::unordered_map<std::string,Triple*> obj_sub_triple;
    sub_type(){
...
typedef struct pre_type{
    ...
    std::unordered_map<std::string,Triple*> sub_pre_triple;
    pre_type(){
...
typedef struct obj_type{
    ...
    std::unordered_map<std::string,Triple*> pre_obj_triple;
    std::unordered_map<std::pair<std::string,std::string>,Triple*,pairhash> spo_triple;
    obj_type(){
